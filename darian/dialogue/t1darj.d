...
IF ~Global("T1DarLovetalk","GLOBAL",10)~ T1DarLovetalk5
  ...
  + ~OR(4) Class(Player1,FIGHTER_CLERIC) Class(Player1,CLERIC_ALL) Class(Player1,CLERIC_THIEF) Class(Player1,CLERIC_MAGE)~ + ~Is something troubling you?~ DO ~IncrementGlobal("T1DarLovetalk","GLOBAL",1) RealSetGlobalTimer("T1DarRomanceTimer","GLOBAL",2500)~ + T1DarLT5cleric
